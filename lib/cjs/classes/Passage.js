...
class Passage {
  ...
  fetchJWKS(resetCache) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const jwks = yield fetch_1.axios
        .get(`${baseAuthURL}/${this.appID}/.well-known/jwks.json`)
        .catch((err) => {
          throw new PassageError_1.PassageError(
            "Could not fetch appID's JWKs",
            err
          );
        })
        .then((res) => {
  ...
  validAuthToken(token) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const key = yield (0, jose_1.importJWK)(jwk);
        const {
          payload: { sub: userID },
        } = yield (0, jose_1.jwtVerify)(token, key, {
          algorithms: [jwk.alg],
        });
  ...
  createMagicLink(magicLinkReq) {
    return __awaiter(this, void 0, void 0, function* () {
      const magicLinkData = yield fetch_1.axios
  ...
  getApp() {
    return __awaiter(this, void 0, void 0, function* () {
      const appData = yield fetch_1.axios
